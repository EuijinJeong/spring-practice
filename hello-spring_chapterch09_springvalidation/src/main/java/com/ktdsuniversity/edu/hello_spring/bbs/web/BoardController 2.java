...
public class BoardController {
	...
	public String doCreateNewBoard(@Valid WriteBoardVO writeBoardVO, BindingResult bindingResult, Model model) {
	 ...
	 * 
	 * @param id: 게시글의 아이디 값.
	 * @param modifyBoardVO: @Valid 의 애노테이션을 통해서 유효성 검사를 받는다.
	 * @param bindingResult: @Valid의 실패 결과만 할당받는다
	 * @param model
	 * @return
	 */
