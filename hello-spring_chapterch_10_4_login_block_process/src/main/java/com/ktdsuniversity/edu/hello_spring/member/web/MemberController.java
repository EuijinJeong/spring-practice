...
public class MemberController {
	...
	public String deleteMember(@SessionAttribute("_LOGIN_USER_") MemberVO memberVO, HttpSession session) {
		boolean isSuccess = memberService.deleteMember(memberVO.getEmail());
